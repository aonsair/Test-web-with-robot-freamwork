...
(function() {
    ...
    var docElem = document.documentElement,
        didScroll = false,
        changeHeaderOn = 550;
    document.querySelector( '#create-sth' );
    function init() {
        window.addEventListener( 'scroll', function() {
            if( !didScroll ) {
                didScroll = true;
...
$(window).scroll(function(event){
    var scroll = $(window).scrollTop();
    if (scroll >= 50) {
        $("#create-sth").addClass("show");
    } else {
        $("#create-sth").removeClass("show");
    }
});
...
(function() {
    ...
    var docElem = document.documentElement,
        didScroll = false,
        changeHeaderOn = 550;
    document.querySelector( '#delete-sth' );
    function init() {
        window.addEventListener( 'scroll', function() {
            if( !didScroll ) {
                didScroll = true;
...
$(window).scroll(function(event){
    var scroll = $(window).scrollTop();
    if (scroll >= 50) {
        $("#delete-sth").addClass("show");
    } else {
        $("#delete-sth").removeClass("show");
    }
});
