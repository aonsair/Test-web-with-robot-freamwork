                    ...
                    <div class="col-xs-12 col-md-11 nav-wrap">
                        <div class="collapse navbar-collapse text-center" id="navbar-collapse">
                            ...
                            <ul class="nav navbar-nav local-scroll text-center">
                                ...
                                <li>
                                    <a id="home_menu" href="#home" style="font-family: 'Kanit', sans-serif, 'Montserrat', sans-serif; font-size: 16px;">
                                        {{ trans('main.Home') }}
                                    </a>
                                </li>
                                <li>
                                    <a id="trip_menu" href="#trip" style="font-family: 'Kanit', sans-serif, 'Montserrat', sans-serif; font-size: 16px;">
                                        {{ trans('main.Trip') }}
                                    </a>
                                </li>
                                <li>
                                    <a id="review_menu" href="#review" style="font-family: 'Kanit', sans-serif, 'Montserrat', sans-serif; font-size: 16px;">
                                        {{ trans('main.Review') }}
                                    </a>
                                </li>
                                <li>
                                    <a id="contact_menu" href="#contact" style="font-family: 'Kanit', sans-serif, 'Montserrat', sans-serif; font-size: 16px;">
                                        {{ trans('main.Contact') }}
                                    </a>
                                </li>
                                ...
                                @guest
                                    <li>
                                        <a href="{{ url('login') }}" id="login_menu" style="font-family: 'Kanit', sans-serif, 'Montserrat', sans-serif; font-size: 16px;">
                                            <i class="fas fa-sign-in-alt"></i> {{ trans('main.Login') }}
                                        </a>
                                    </li>
                                    @if (Route::has('register'))
                                        <li>
                                            <a href="{{ url('register') }}" id="register_menu" style="font-family: 'Kanit', sans-serif, 'Montserrat', sans-serif; font-size: 16px;">
                                ...
                                @else
                                    ...
                                    {{--</li>--}}
                                    <li>
                                        <a id="logout_menu" class="hoverc" style="font-family: 'Kanit', sans-serif, 'Montserrat', sans-serif; font-size: 16px;" href="{{ url('logout') }}" onclick="event.preventDefault(); document.getElementById('logout-form').submit();">
                                ...
                                <li>
                                    @if(session()->has('locale'))
                                        <a style="font-size: 16px;" href="{{ url('lang/' . ((session()->get('locale')=='th')? 'en' : 'th')) }}" > {{ Str::upper((session()->get('locale')=='th')?'en':'th') }}</a>
                                    @else
            ...
            <div class="row">
                ...
                <div class="col-md-4 col-md-offset-4">
                    ...
                    <span class="copyright text-center">
                      <span style="color: #fff">&copy; 2018 {{ trans('main.ThailandPortal') }}  |  {{ trans('main.Development') }}  </span> <br>  <a
                                style="font-size: 14px;" href="http://www.topumin.com/"> {{ trans('main.by') }} {{ trans('main.ThailandPortal') }}</a>
                </span>
...
<nav class="navbar navbar-fixed-bottom" style="margin-bottom: 0">
    @yield('response')
</nav>
<!-- jQuery Scripts -->
